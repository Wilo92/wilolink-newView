...
// ============================================================
const DOT_SIZE = 9; // px, el punto central
const RING_SIZE = 36; // px, tamaño base del aro
const RING_BORDER = 2; // px
...
export default function CustomCursor() {
    ...
    useEffect(() => {
        ...
        function tick() {
            dot!.style.transform = `translate3d(${mouse.x - DOT_SIZE / 2}px, ${mouse.y - DOT_SIZE / 2
                }px, 0)`;
            ...
            ring!.style.transform = `translate3d(${ringPos.x - RING_SIZE / 2}px, ${ringPos.y - RING_SIZE / 2
                }px, 0) rotate(${smoothAngle}rad) scale(${scaleX * currentScale}, ${scaleY * currentScale
                })`;
